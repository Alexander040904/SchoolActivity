...
@else
        ...
        @section('nav-responsive')
            <x-responsive-nav-link :href="route('activation', 1)" :active="request()->query('source') === '1'">
                {{ __('Activos') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('activation', 2)" :active="request()->query('source') === '2'">
                {{ __('Inactivos') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('activation', 2)" :active="request()->query('source') === '2'">
                {{ __('Crear carrera') }}
